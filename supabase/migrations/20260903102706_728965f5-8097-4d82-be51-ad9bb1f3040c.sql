...
begin
  ...
  -- Campaigns (owned by the demo account so brand view also works)
  insert into campaigns (brand_id, title, topic, angle, must_include, avoid, hashtags, budget, rate_per_1k, deadline, status, funded_amount, spent_amount)
  values (
    p_user_id, 'Sparkling Yuzu Soda — Summer Push',
  ...
  (
    p_user_id, 'Kampala Street Food Crawl',
  ...
  (
    p_user_id, 'Budget Phone Photography Challenge',
  ...
  -- Submissions for the demo creator on two campaigns
  ...
  -- Earnings + ledger matching the first submission
